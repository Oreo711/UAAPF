...
namespace _Project.Develop.Runtime.Infrastructure.DI
{
	public class DIContainer
	{
		...
		public void RegisterAsSingle<T> (Func<DIContainer, T> creator)
		{
			...
			{
				throw new InvalidOperationException($"Dependency of type {typeof(T)} is already registered");
			}
		...
		public T Resolve<T> ()
		{
			...
			throw new InvalidOperationException($"Registration for {typeof(T)} does not exist.");
		}
	}
}
